            ...
            <div class="b-cart_table-rows">
              ...
              <div class="b-cart_table-cols b-cart_table-body_col_qty">
                <div class="b-cart_table-body_col_qty-item_quantity">
                  <span class="b-cart_table-body_col_qty-item_quantity-minus" onclick="cart.update('<?php echo $product["cart_id"]; ?>', <?php echo ((int)$product['quantity'] - 1); ?>);"></span>
                  ...
                  <span class="b-cart_table-body_col_qty-item_quantity-plus" onclick="cart.update('<?php echo $product["cart_id"]; ?>', <?php echo ((int)$product['quantity'] + 1); ?>);"></span>
                </div>
              </div>
