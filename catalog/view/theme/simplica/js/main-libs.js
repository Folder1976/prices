...
/* Array.prototype.indexOf || (Array.prototype.indexOf = function(a) {
    ...
    function(a, b) {
        function l(a, b) {
            return a && k[a] && k[a][b] ? k[a][b] : k[e] && k[e][b] ? k[e][b] : b
        }

        function m(e, k) {
            var n, o, p, q, r, s;
            if ("object" == typeof e) {
                for (s = [], r = 0; r < e.length; r++) s.push(m(e[r]));
                return k && k.apply(k, s), s
            }
            if (e = l(j.length && j[j.length - 1], e), d[e] || 0 !== e.indexOf(f)) {
                if (c[e]) return c[e];
                if (d[e]) {
                    if (j.length > g || j.indexOf(e) > 0) throw "Loop detected: " + j + "->" + e;
                    return j.push(e), n = {
                        exports: {},
                        name: e
                    }, d[e].requireModules ? (o = m(d[e].requireModules), s = d[e].factory.apply(n.exports, o)) : s = "function" == typeof d[e].factory ? d[e].factory.call(n.exports, m, n.exports, n) : d[e].factory, c[e] = s === b ? n.exports : s, j.pop(), c[e]
                }
                throw i + e
            }
            for (p = e.split(h), q = a, r = 0; r < p.length; r++) {
                if (q[p[r]] === b) throw new Error(i + e);
                q = q[p[r]]
            }
            return q
        }
        var c = {},
            ...
            j = [],
            k = {};
        a.define || (a.define = function(b, c, e) {
            if ("string" != typeof b) throw new Error("Module can by defined only witn name");
            if (d[b]) throw new Error("Module already defined: " + b);
            if (d[b] = {
                factory: c,
                name: b
            }, "function" == typeof e && (d[b].requireModules = c, d[b].factory = e), 0 === b.indexOf(f)) {
                for (var g = b.split(h), i = a, j = 0; j < g.length - 1; j++) i[g[j]] || (i[g[j]] = {}), i = i[g[j]];
                i[g[j]] = m(b)
            }
        }, a.define.map = k, a.define.amd = {})
    }(this); */
