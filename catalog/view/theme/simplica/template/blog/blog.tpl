        ...
        <?php foreach ($products as $product) { ?>
          <div class="blog_item blog_product">
            ...
            <?php if ((float)VERSION >= 2.1) { ?>
              <a class="f-button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><?php echo $button_cart; ?></a>
            <?php } else { ?>
              <a class="f-button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></a>
            <?php } ?>
