...
<?php while($value = $r->fetch_assoc()){ ?>
 <tr id="<?php echo $value['baner_id']; ?>">
      ...
      <td>
		  ...
		  <br><b><b>Заголовок банера [title]</b> : <input type="text" id="header<?php echo $value['baner_id']; ?>" class="brand edit" data-id="<?php echo $value['baner_id']; ?>" style="width:600px;" value="<?php echo $value['baner_header']; ?>">
			<br>Текст банера</b> : <input type="text" id="text<?php echo $value['baner_id']; ?>" class="brand edit" data-id="<?php echo $value['baner_id']; ?>" style="width:600px;" value="<?php echo $value['baner_text']; ?>">
