...
jQuery(document).ready(function () {
    console.log("Folder 2016 - ok");
        jQuery.getScript('/js/backend/ajax_product_moderation.js');
        jQuery.getScript('/js/backend/ajax_edit.js');
        jQuery.getScript('/js/backend/ajax_edit_shop.js');
        jQuery.getScript('/js/backend/ajax_edit_size.js');
        jQuery.getScript('/js/backend/ajax_edit_filters.js');
        jQuery.getScript('/js/backend/ajax_edit_brand.js');
        console.log("libs load - ok");
    });
