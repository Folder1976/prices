...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['customer_shop_id'])) {
			$customer_shop_id = $this->request->post['customer_shop_id'];
		} elseif (!empty($customer_info)) {
			$data['customer_shop_id'] = $customer_info['customer_shop_id'];
		}else{
			$customer_shop_id = 0;
		}
		...
		$rows = $this->model_marketing_shop->getShops();
		$shop = array();
