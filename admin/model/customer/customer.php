...
class ModelCustomerCustomer extends Model {
	public function addCustomer($data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "customer_shops WHERE customer_id = '" . (int)$customer_id . "'");
		if (isset($data['customer_shop_id'])) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "customer_shops SET customer_id = '" . (int)$customer_id . "', shop_id = '" . (int)$data['customer_shop_id'] . "'");
		}
