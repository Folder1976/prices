                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-customer-group"><?php echo $entry_shop; ?></label>
                        <div class="col-sm-10">
                          <select name="customer_shop_id" id="input-customer-shop" class="form-control">
                            <?php foreach ($shops as $index => $shop) { ?>
                              <?php if ($index == $customer_shop_id) { ?>
                                <option value="<?php echo $index; ?>" selected="selected"><?php echo $shop['name']; ?></option>
                              <?php } else { ?>
                                <option value="<?php echo $index; ?>"><?php echo $shop['name']; ?></option>
                              <?php } ?>
                            <?php } ?>
                          </select>
                        </div>
