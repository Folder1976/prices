...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $settings; ?>" data-toggle="tooltip" title="<?php echo $button_settings; ?>" class="btn btn-primary"><?php echo $button_settings; ?></a>
...
$('#button-filter').on('click', function() {
    url = 'index.php?route=module/megareviews&token=<?php echo $token; ?>';
