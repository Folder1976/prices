...
<script type="text/javascript" src="/<?php echo TMP_DIR; ?>admin/view/javascript/jquery/jquery-2.1.1.min.js"></script>
...
<script src="/<?php echo TMP_DIR; ?>admin/view/javascript/jquery/datetimepicker/moment.js" type="text/javascript"></script>
<script src="/<?php echo TMP_DIR; ?>admin/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<link href="/<?php echo TMP_DIR; ?>admin/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
<link type="text/css" href="/<?php echo TMP_DIR; ?>admin/view/stylesheet/stylesheet.css" rel="stylesheet" media="screen" />
...
<?php } ?>
<script src="/<?php echo TMP_DIR; ?>admin/view/javascript/common.js" type="text/javascript"></script>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="/<?php echo TMP_DIR; ?>admin/view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
