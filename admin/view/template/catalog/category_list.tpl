    ...
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $import; ?>" data-toggle="tooltip" title="<?php echo $button_import; ?>" class="btn btn-danger">
          <i class="fa fa-plus"></i> <i class="fa fa-plus"></i>Импорт категорий из blockb5_etalon
        </a>
        ...
        <a href="<?php echo $repair; ?>" data-toggle="tooltip" title="<?php echo $button_rebuild; ?>" class="btn btn-default">
...
<?php echo $footer; ?>
 ...
 <!-- ДЕРЕВО -->
      <!-- ======================================================================== -->
        <!--link rel="stylesheet" type="text/css" href="/backend/libs/category_tree/type-for-get.css"-->
